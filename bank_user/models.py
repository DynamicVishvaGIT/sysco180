...
class BankCases(SoftDeleteTimestampMixin, models.Model):
    BANK_USER              = models.ForeignKey("user.Bank_individual_user", on_delete=models.CASCADE,null=True,blank=True)


class Cases(SoftDeleteTimestampMixin, models.Model):
    BANK_CASES                 = models.ForeignKey("bank_user.BankCases", on_delete=models.CASCADE,null=True,blank=True)
